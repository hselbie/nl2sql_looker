...
def get_description(file_path):
    ...
    predictor = llm_helper.VertexLLM(model_name='gemini-pro', max_output_tokens=8000, temperature=0.5, top_p=0.9, top_k=5)
    helper = f'''
    ...
    new_description = ast.literal_eval(new_description)
...
if __name__ == '__main__':
    ...
    while len(key) < len(lookml_files):
        try:
