...
def get_description(file_path):
    ...
    write a description field for each lookml field object ignoring the view object and return in a list of dictionaries in the format 
    [{{'name':{{LOOKML OBJECT NAME}}, 'description' :{{}}}}, {{'name':{{LOOKML OBJECT NAME}}, 'description' :{{}}}}]'''
