...
for dict in dict_list:
    ...
    write a natural language summarization of the values from the json keys. Ignore any values with "nan"
    The intended result is a description field for this object.'''
