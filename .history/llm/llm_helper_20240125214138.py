...
if __name__ == "__main__":
  ...
  with open("lookml/descriptions.txt", "r") as f:
    lookml_data = f.read()
  query = 'what is my revenue calculated by sale price for products sold in the last 28 days?' 
...
Example 2: "what are my high value geographies for my top 5 selling products?"
Example Response 2:{{
