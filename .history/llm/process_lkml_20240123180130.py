...
for dict in dict_list:
    ...
    write a description field for this object extracting the values from the json keys. only list entities that were given in the dict. 
    Ignore any values with "nan" ensure the result reads well 
    and is grammatically correct and complete. Only return the description text about the field referenced in the json.'''
