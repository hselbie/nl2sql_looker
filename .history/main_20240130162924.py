...
Respond using valid JSON format only.
Adhere strictly to the provided JSON schema. Fill in missing values with appropriate defaults (e.g., null, empty array, etc.) if the information is unavailable or cannot be determined.
