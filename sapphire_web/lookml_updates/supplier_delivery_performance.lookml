- dashboard: supplier_delivery_performance_trend
  title: Supplier Delivery Performance Trend
  layout: newspaper
  preferred_viewer: dashboards-next
  description: 'KPIs on delivery performance of suppliers for materials required for
    products, by product, purchasing organisation, purchasing groups and supplier
    name.  Includes trends on on-time, in-full and delays for purchase orders of each
    supplier '
  ...
  - title: Delivery Performance Detailed Report
    ...
    listen:
      ...
      Product Category: vendor_performance.material_type_description
      Product: vendor_performance.material_description
      Supplier Number: vendor_performance.vendor_account_number_lifnr
      Supplier Name: vendor_performance.name1
      Supplier Country: vendor_performance.country_key_land1
    row: 8
    col: 0
    width: 24
    height: 6
  ...
  - name: Company Code
    ...
    model: cortex-demo-genai
    explore: vendor_performance
    listens_to_filters: [Supplier Country, Supplier Name, Material Type Description,
      Product, Product Category, Supplier Number, Purchasing Group, Purchasing Organization]
  ...
  - name: Purchasing Organization
    ...
    model: cortex-demo-genai
    explore: vendor_performance
    listens_to_filters: [Company Code, Supplier Country, Supplier Name, Material Type
        Description, Product, Product Category, Supplier Number, Purchasing Group]
  ...
  - name: Purchasing Group
    ...
    explore: vendor_performance
    listens_to_filters: [Company Code, Supplier Country, Supplier Name, Material Type
        Description, Product, Product Category, Supplier Number, Purchasing Organization]
  ...
  - name: Supplier Country
    ...
    model: cortex-demo-genai
    explore: vendor_performance
    listens_to_filters: [Company Code, Supplier Name, Material Type Description, Product,
      Product Category, Supplier Number, Purchasing Group, Purchasing Organization]
  ...
  - name: Supplier Name
    ...
    model: cortex-demo-genai
    explore: vendor_performance
    listens_to_filters: [Company Code, Supplier Country, Material Type Description,
      Product, Product Category, Supplier Number, Purchasing Group, Purchasing Organization]
  ...
  - name: Supplier Number
    ...
    explore: vendor_performance
    listens_to_filters: [Company Code, Supplier Country, Supplier Name, Material Type
        Description, Product, Product Category, Purchasing Group, Purchasing Organization]
  ...
  - name: Product Category
    ...
    model: cortex-demo-genai
    explore: vendor_performance
    listens_to_filters: [Supplier Number, Purchasing Group, Purchasing Organization]
  ...
  - name: Product
    ...
    model: cortex-demo-genai
    explore: vendor_performance
    listens_to_filters: [Product Category, Supplier Number, Purchasing Group, Purchasing
        Organization]
