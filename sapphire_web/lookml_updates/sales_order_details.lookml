- dashboard: sales_order_details
  ...
  description: KPIs and details on total sales orders with order status (open, closed,
    cancelled and blocked orders) by criteria like region, sales organisation, product
    and customers
  preferred_slug: TPyAUEOGWWx01JgxCLavfx
  elements:
  - name: Order Details
    type: text
  ...
  - name: Year
    title: Year
    type: field_filter
    default_value: 2022/07/01 to 2023/03/31
