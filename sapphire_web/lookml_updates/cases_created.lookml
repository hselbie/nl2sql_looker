- dashboard: case_overview__trends
  ...
  description: Overview of customer cases with status, priority and age. Includes
    customer case details
  preferred_slug: NpaOG12HfP7wrtcfL5KnOF
  elements:
  - title: Total Cases Created
    ...
    listen:
      ...
      Customer: case_management.account_name
    row: 4
    col: 0
    width: 6
    height: 2
  ...
  - title: All Open Cases by Priority, Age & Status
    ...
    fields: [case_management.case_number, case_management.account_name, case_management.priority,
      ...
      case_management.subject, case_status_sort_order, case_management.case_created_date,
      case_management.case_owner_name]
    filters:
      case_management.case_is_closed: 'No'
    sorts: [priority_sort_order, case_age_days asc, case_status_sort_order]
    limit: 500
