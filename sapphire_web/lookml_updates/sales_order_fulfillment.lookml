- dashboard: sales_order_fulfillment
  ...
  - name: Order Fulfillment
    ...
    width: 24
    height: 2
  - name: <a href="/dashboards/cortex-demo-genai::sap_order_to_cash_o2c_01_a_delivery_performance_performance_tuning">Delivery
      Performance</a>
    type: text
  ...
  - title: Sales Order Fulfilment
    ...
    note_display: below
    note_text: On time delivery performance
    listen:
      Year: sales_orders.creation_date_erdat_date
      Currency: currency_conversion_new.tcurr
      Region: countries_md.country_name_landx
